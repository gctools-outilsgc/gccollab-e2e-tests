export HAIBUN_O_OUTREVIEWS_TRACE_STORAGE=StorageFS HAIBUN_TRACE=true HAIBUN_O_WEBPLAYWRIGHT_STORAGE=StorageFS HAIBUN_DEST=e2e \
    HAIBUN_O_WEBPLAYWRIGHT_CAPTURE_VIDEO=true HAIBUN_O_WEBPLAYWRIGHT_HEADLESS=${true:-HAIBUN_O_WEBPLAYWRIGHT_HEADLESS} \
    HAIBUN_O_OUTREVIEWS_REVIEWS_STORAGE=StorageFS  HAIBUN_OUTPUT=~@haibun/out-xunit/build/out-xunit HAIBUN_TITLE="GCCollab e2e tests" HAIBUN_ENVC=${HAIBUN_ENVC:-_ENVC} 
